...
export const Form = ({pacientes, setPacientes, paciente, setPaciente}) => {
  ...
  const handleSubmit = (e) => {
      ...
      if (paciente.id) {
        //Identifica si está Editando el registro
        ...
        //Identifica si es Nuevo registro
  ...
  return (
    <div className="md:w-1/2 lg:w-2/5 mx-5">
        ...
        <form 
            ...
            <div className="mb-5">
              <label htmlFor='mascota' className="block text-gray uppercase font-bold">
                Nombre Mascota
                </label>
              <input 
                  id="mascota"
            ...
            <div className="mb-5">
              <label htmlFor='propietario' className="block text-gray uppercase font-bold">
                Nombre Propietario
                </label>
              <input 
                  id="propietario"
            ...
            <div className="mb-5">
              <label htmlFor='email' className="block text-gray uppercase font-bold">
                E-Mail
                </label>
              <input 
                  id="email"
            ...
            <div className="mb-5">
              <label htmlFor='fecha' className="block text-gray uppercase font-bold">
                Fecha de Alta
                </label>
              <input 
                  id="fecha"
            ...
            <div className="mb-5">
              <label htmlFor='sintomas' className="block text-gray uppercase font-bold">
                Síntomas
                </label>
              <textarea 
                id="sintomas"
